...
- `math-runner.png` — thumbnail for the Math Runner game (the supplied wide
  key-art padded to a square with sky/road-matched bars, then 256-colour
  quantised to keep the precache small)
